...
const dataSet = [
	{
	  ...
	  url: "https://www.youtube.com/watch?v=xHe1zkQxkAI",
	  category: "양식",
	},
	{
	  title: "즉석우동짜장",
	  address: "서울 영등포구 대방천로 260",
	  url: "https://www.youtube.com/watch?v=l2suP2ZNwjY",
	  category: "한식",
	},
	{
	  title: "아카사카",
...
function categoryHandler(event){
    ...
    let categorizdDataSet = [];
    for (let data of dataSet) {
        if(data.category === category) {
            categorizdDataSet.push(data);
        }
    }
